...
Cf2py intent(in,out) ift
Cf2py intent(in,out) x
Cf2py intent(in,out) e
Cf2py intent(in) s
Cf2py intent(in) wa
Cf2py intent(in) wb
Cf2py intent(in) nsol
Cf2py intent(in) ndsol
Cf2py intent(in,out) sol
Cf2py intent(in,out) dsol
Cf2py intent(in,out) lsol
Cf2py intent(in,out) h
Cf2py intent(in,out) qn
Cf2py intent(in,out) cutoff
Cf2py intent(in,out) ci
Cf2py intent(in,out) tnmat
Cf2py intent(in) big
Cf2py intent(in) lci1
